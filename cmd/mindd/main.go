...
import (
	...
	artfsdrv "github.com/vibed-project/mindD/internal/artifact/drivers/fs"
	artmemdrv "github.com/vibed-project/mindD/internal/artifact/drivers/memory"
	...
	graphmemdrv "github.com/vibed-project/mindD/internal/graph/drivers/memory"
	graphpgdrv "github.com/vibed-project/mindD/internal/graph/drivers/postgres"
	...
	leasememdrv "github.com/vibed-project/mindD/internal/lease/drivers/memory"
	leasepgdrv "github.com/vibed-project/mindD/internal/lease/drivers/postgres"
	...
	semmemdrv "github.com/vibed-project/mindD/internal/semantic/drivers/memory"
	sempgdrv "github.com/vibed-project/mindD/internal/semantic/drivers/postgres"
	"github.com/vibed-project/mindD/internal/semantic/embedder"
	embollama "github.com/vibed-project/mindD/internal/semantic/embedder/ollama"
	embopenai "github.com/vibed-project/mindD/internal/semantic/embedder/openai"
...
func main() {
	if err := run(); err != nil {
		fmt.Fprintln(os.Stderr, "mindd:", err)
		os.Exit(1)
	}
}
...
func run() error {
	...
	if *showVersion {
		fmt.Println("mindd", version.String())
		return nil
	}
	if *cfgPath == "" {
	...
	// Namespace-growth gauge (mindd.namespace.items) over every block's
