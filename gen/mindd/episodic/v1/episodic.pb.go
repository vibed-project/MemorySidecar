...
func (ExpireAction) Descriptor() protoreflect.EnumDescriptor {
	return file_mindd_episodic_v1_episodic_proto_enumTypes[0].Descriptor()
}

func (ExpireAction) Type() protoreflect.EnumType {
	return &file_mindd_episodic_v1_episodic_proto_enumTypes[0]
}
...
func (ExpireAction) EnumDescriptor() ([]byte, []int) {
	return file_mindd_episodic_v1_episodic_proto_rawDescGZIP(), []int{0}
}
...
func (x *Event) Reset() {
	*x = Event{}
	mi := &file_mindd_episodic_v1_episodic_proto_msgTypes[0]
...
func (x *AppendRequest) Reset() {
	*x = AppendRequest{}
	mi := &file_mindd_episodic_v1_episodic_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AppendRequest) Descriptor() ([]byte, []int) {
	return file_mindd_episodic_v1_episodic_proto_rawDescGZIP(), []int{1}
}
...
func (x *AppendResponse) Reset() {
	*x = AppendResponse{}
	mi := &file_mindd_episodic_v1_episodic_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AppendResponse) Descriptor() ([]byte, []int) {
	return file_mindd_episodic_v1_episodic_proto_rawDescGZIP(), []int{2}
}
...
func (x *RangeRequest) Reset() {
	*x = RangeRequest{}
	mi := &file_mindd_episodic_v1_episodic_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*RangeRequest) Descriptor() ([]byte, []int) {
	return file_mindd_episodic_v1_episodic_proto_rawDescGZIP(), []int{3}
}
...
func (x *TailRequest) Reset() {
	*x = TailRequest{}
	mi := &file_mindd_episodic_v1_episodic_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*TailRequest) Descriptor() ([]byte, []int) {
	return file_mindd_episodic_v1_episodic_proto_rawDescGZIP(), []int{4}
}
...
type ExpireRequest struct {
	...
	Action     ExpireAction           `protobuf:"varint,4,opt,name=action,proto3,enum=mindd.episodic.v1.ExpireAction" json:"action,omitempty"`
...
func (x *ExpireRequest) Reset() {
	*x = ExpireRequest{}
	mi := &file_mindd_episodic_v1_episodic_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ExpireRequest) Descriptor() ([]byte, []int) {
	return file_mindd_episodic_v1_episodic_proto_rawDescGZIP(), []int{5}
}
...
func (x *ExpireResponse) Reset() {
	*x = ExpireResponse{}
	mi := &file_mindd_episodic_v1_episodic_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ExpireResponse) Descriptor() ([]byte, []int) {
	return file_mindd_episodic_v1_episodic_proto_rawDescGZIP(), []int{6}
}
...
var File_mindd_episodic_v1_episodic_proto protoreflect.FileDescriptor

const file_mindd_episodic_v1_episodic_proto_rawDesc = "" +
	"\n" +
	...
	"\bmetadata\x18\x06 \x03(\v2&.mindd.episodic.v1.Event.MetadataEntryR\bmetadata\x12\x12\n" +
	...
	"\apayload\x18\x03 \x01(\fR\apayload\x12J\n" +
	"\bmetadata\x18\x04 \x03(\v2..mindd.episodic.v1.AppendRequest.MetadataEntryR\bmetadata\x12\x12\n" +
	...
	"\x05event\x18\x01 \x01(\v2\x18.mindd.episodic.v1.EventR\x05event\"\x8c\x03\n" +
	...
	"\tnamespace\x18\x01 \x01(\tR\tnamespace\x12!\n" +
	"\fafter_cursor\x18\x02 \x01(\x04R\vafterCursor\x12-\n" +
	"\x12include_historical\x18\x03 \x01(\bR\x11includeHistorical\"\xe3\x01\n" +
	...
	"beforeTime\x127\n" +
	"\x06action\x18\x04 \x01(\x0e2\x1f.mindd.episodic.v1.ExpireActionR\x06action\x12\x19\n" +
	...
	"\x19EXPIRE_ACTION_HARD_DELETE\x10\x022\xb2\x02\n" +
	"\bEpisodic\x12M\n" +
	"\x06Append\x12 .mindd.episodic.v1.AppendRequest\x1a!.mindd.episodic.v1.AppendResponse\x12D\n" +
	"\x05Range\x12\x1f.mindd.episodic.v1.RangeRequest\x1a\x18.mindd.episodic.v1.Event0\x01\x12B\n" +
	"\x04Tail\x12\x1e.mindd.episodic.v1.TailRequest\x1a\x18.mindd.episodic.v1.Event0\x01\x12M\n" +
	"\x06Expire\x12 .mindd.episodic.v1.ExpireRequest\x1a!.mindd.episodic.v1.ExpireResponseB\xcd\x01\n" +
	"\x15com.mindd.episodic.v1B\rEpisodicProtoP\x01Z?github.com/vibed-project/mindD/gen/mindd/episodic/v1;episodicv1\xa2\x02\x03MEX\xaa\x02\x11Mindd.Episodic.V1\xca\x02\x11Mindd\\Episodic\\V1\xe2\x02\x1dMindd\\Episodic\\V1\\GPBMetadata\xea\x02\x13Mindd::Episodic::V1b\x06proto3"

var (
	file_mindd_episodic_v1_episodic_proto_rawDescOnce sync.Once
	file_mindd_episodic_v1_episodic_proto_rawDescData []byte
)

func file_mindd_episodic_v1_episodic_proto_rawDescGZIP() []byte {
	file_mindd_episodic_v1_episodic_proto_rawDescOnce.Do(func() {
		file_mindd_episodic_v1_episodic_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_mindd_episodic_v1_episodic_proto_rawDesc), len(file_mindd_episodic_v1_episodic_proto_rawDesc)))
	})
	return file_mindd_episodic_v1_episodic_proto_rawDescData
}

var file_mindd_episodic_v1_episodic_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_mindd_episodic_v1_episodic_proto_msgTypes = make([]protoimpl.MessageInfo, 9)
var file_mindd_episodic_v1_episodic_proto_goTypes = []any{
	(ExpireAction)(0),             // 0: mindd.episodic.v1.ExpireAction
	(*Event)(nil),                 // 1: mindd.episodic.v1.Event
	(*AppendRequest)(nil),         // 2: mindd.episodic.v1.AppendRequest
	(*AppendResponse)(nil),        // 3: mindd.episodic.v1.AppendResponse
	(*RangeRequest)(nil),          // 4: mindd.episodic.v1.RangeRequest
	(*TailRequest)(nil),           // 5: mindd.episodic.v1.TailRequest
	(*ExpireRequest)(nil),         // 6: mindd.episodic.v1.ExpireRequest
	(*ExpireResponse)(nil),        // 7: mindd.episodic.v1.ExpireResponse
	nil,                           // 8: mindd.episodic.v1.Event.MetadataEntry
	nil,                           // 9: mindd.episodic.v1.AppendRequest.MetadataEntry
	(*timestamppb.Timestamp)(nil), // 10: google.protobuf.Timestamp
}
var file_mindd_episodic_v1_episodic_proto_depIdxs = []int32{
	10, // 0: mindd.episodic.v1.Event.timestamp:type_name -> google.protobuf.Timestamp
	8,  // 1: mindd.episodic.v1.Event.metadata:type_name -> mindd.episodic.v1.Event.MetadataEntry
	10, // 2: mindd.episodic.v1.Event.deleted_at:type_name -> google.protobuf.Timestamp
	9,  // 3: mindd.episodic.v1.AppendRequest.metadata:type_name -> mindd.episodic.v1.AppendRequest.MetadataEntry
	1,  // 4: mindd.episodic.v1.AppendResponse.event:type_name -> mindd.episodic.v1.Event
	10, // 5: mindd.episodic.v1.RangeRequest.after_time:type_name -> google.protobuf.Timestamp
	10, // 6: mindd.episodic.v1.RangeRequest.before_time:type_name -> google.protobuf.Timestamp
	10, // 7: mindd.episodic.v1.ExpireRequest.before_time:type_name -> google.protobuf.Timestamp
	0,  // 8: mindd.episodic.v1.ExpireRequest.action:type_name -> mindd.episodic.v1.ExpireAction
	2,  // 9: mindd.episodic.v1.Episodic.Append:input_type -> mindd.episodic.v1.AppendRequest
	4,  // 10: mindd.episodic.v1.Episodic.Range:input_type -> mindd.episodic.v1.RangeRequest
	5,  // 11: mindd.episodic.v1.Episodic.Tail:input_type -> mindd.episodic.v1.TailRequest
	6,  // 12: mindd.episodic.v1.Episodic.Expire:input_type -> mindd.episodic.v1.ExpireRequest
	3,  // 13: mindd.episodic.v1.Episodic.Append:output_type -> mindd.episodic.v1.AppendResponse
	1,  // 14: mindd.episodic.v1.Episodic.Range:output_type -> mindd.episodic.v1.Event
	1,  // 15: mindd.episodic.v1.Episodic.Tail:output_type -> mindd.episodic.v1.Event
	7,  // 16: mindd.episodic.v1.Episodic.Expire:output_type -> mindd.episodic.v1.ExpireResponse
...
func init() { file_mindd_episodic_v1_episodic_proto_init() }
func file_mindd_episodic_v1_episodic_proto_init() {
	if File_mindd_episodic_v1_episodic_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_mindd_episodic_v1_episodic_proto_rawDesc), len(file_mindd_episodic_v1_episodic_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   9,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_mindd_episodic_v1_episodic_proto_goTypes,
		DependencyIndexes: file_mindd_episodic_v1_episodic_proto_depIdxs,
		EnumInfos:         file_mindd_episodic_v1_episodic_proto_enumTypes,
		MessageInfos:      file_mindd_episodic_v1_episodic_proto_msgTypes,
	}.Build()
	File_mindd_episodic_v1_episodic_proto = out.File
	file_mindd_episodic_v1_episodic_proto_goTypes = nil
	file_mindd_episodic_v1_episodic_proto_depIdxs = nil
}
