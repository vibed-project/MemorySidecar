...
func RegisterAdminHandlerServer(ctx context.Context, mux *runtime.ServeMux, server AdminServer) error {
	mux.Handle(http.MethodPost, pattern_Admin_ListNamespaces_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/mindd.admin.v1.Admin/ListNamespaces", runtime.WithHTTPPathPattern("/mindd.admin.v1.Admin/ListNamespaces"))
		if err != nil {
...
func RegisterAdminHandlerClient(ctx context.Context, mux *runtime.ServeMux, client AdminClient) error {
	mux.Handle(http.MethodPost, pattern_Admin_ListNamespaces_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		annotatedContext, err := runtime.AnnotateContext(ctx, mux, req, "/mindd.admin.v1.Admin/ListNamespaces", runtime.WithHTTPPathPattern("/mindd.admin.v1.Admin/ListNamespaces"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	pattern_Admin_ListNamespaces_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"mindd.admin.v1.Admin", "ListNamespaces"}, ""))
)
