// Capability-token auth for the memsidecar SDK.
//
// Every RPC requires a capability token carried in the gRPC metadata key
// "x-memsidecar-capability" with value "Bearer <token>". This interceptor
...
export const CAPABILITY_HEADER = "x-memsidecar-capability";

/**
 * Build an interceptor that stamps `x-memsidecar-capability: Bearer <token>`
